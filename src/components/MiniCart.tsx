              ...
              {items.map((item) => (
                <div key={item.id} className="relative flex gap-4 p-4 pr-10">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 w-8 h-8 flex items-center justify-center text-neutral-300 hover:text-red-400 hover:bg-red-50 rounded-full transition-colors"
